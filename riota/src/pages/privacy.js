  ...
  return (
    ...
    >
      ...
      <div className="relative inset-x-0  ml-[8%] mr-[8%] width-[10%]">
        ...
        <p className="relative font-medium font-abc text-white text-[18px]">
          RIOTA (“us”, “we”, or “our”) operates www.riota.in (hereinafter
          referred to as “Service”).
        </p>
        <p className="relative font-medium font-abc text-white text-[18px]">
          Our Privacy Policy governs your visit to www.riota.in, and explains
      ...
      <div className="relative inset-x-0  ml-[8%] mr-[8%] width-[10%] ">
        <p className="relative font-medium font-abc text-white text-[18px]">
          SERVICE : means the www.riota.in website operated by RIOTA.
        </p>
        <p className="relative font-medium font-abc text-white text-[18px]">
      ...
      <div className="relative inset-x-0  ml-[8%] mr-[8%] width-[10%] ">
        ...
        <br></br>
        <p className="relative font-medium font-abc text-white text-[24px]">
          Other Data
        </p>
        <p className="relative font-medium font-abc text-white text-[18px]">
      ...
      <div className="relative inset-x-0  ml-[8%] mr-[8%] width-[10%] ">
        <p className="relative font-medium font-abc text-white text-[18px]">
          RIOTA uses the collected data for various purposes:
        </p>
        <br></br>
        <p className="relative font-medium font-abc text-white text-[18px]">
      ...
      <div className="relative inset-x-0  ml-[8%] mr-[8%] width-[10%] ">
        ...
        <p className="relative font-medium font-abc text-white text-[18px]">
          RIOTA will take all the steps reasonably necessary to ensure that your
      ...
      <div className="relative inset-x-0  ml-[8%] mr-[8%] width-[10%] ">
        ...
        <p className="relative font-medium font-abc text-white text-[18px]">
          ...
          please send your request(s) by email: info@riota.in.
        </p>
        <p className="relative font-medium font-abc text-white text-[18px]">
